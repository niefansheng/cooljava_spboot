...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${r"${path}"}/res/css/public.css" />
</head>
<body>
	<blockquote class="layui-elem-quote">
		<form class="layui-form">
			<div class="layui-inline">
				...
				<a class="layui-btn search-btn" data-type="reload"><i class="layui-icon">&#xe615;</i>搜索</a>
			</div>
			<div class="layui-inline">
				<a class="layui-btn layui-btn-normal add-btn"><i class="layui-icon">&#xe608;</i>添加${functionComment}</a>
			</div>
			<div class="layui-inline">
